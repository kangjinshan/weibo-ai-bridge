...
| P0-5 | 已修复 | `8723a82`：`/listen` 与 `/super` 后台任务派生自 Router root ctx，`/listen` 支持 JSONL rotate 后 reopen。 |
| P0-6 | 已修复 | `fa889f6`：`/new` 使用一次 session 锁原子切换 AgentType 并清空 native session id。 |
| P0-7 | 已修复 | `8723a82`：WebSocket 重连改为 1s→2s→4s→30s 封顶退避，连续 10 次鉴权失败后停止重连。 |
...
1. **P0 已全部完成**：P0-1, P0-2, P0-3, P0-4, P0-5, P0-6, P0-7, P0-8, P0-9。
2. **已完成的 P1/P2**：P1-1, P1-4, P1-6, P1-8, P2-9。
