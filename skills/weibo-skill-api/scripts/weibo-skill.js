 ...
 *
 * 配置来源:
 *   复用 weibo-ai-bridge 的 TOML 配置、环境变量和 token 缓存
 */
...
配置文件路径:
  复用 weibo-ai-bridge 的 CONFIG_PATH、/etc/weibo-ai-bridge/config.toml、仓库 config/config.toml
  或 WEIBO_APP_ID / WEIBO_APP_SECRET 环境变量；无需单独 login
`);
}
